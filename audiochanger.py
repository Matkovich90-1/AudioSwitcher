...
class AudioSwitcher:
    ...
    def get_audio_sinks(self):
        ...
        try:
            ...
            # --- WINDOWS SIDE (FIXED FOR INSTALLER) ---
            elif platform.system() == "Windows":
                # WMIC is much more reliable inside a Windows Installer
    ...
    def refresh_ui(self):
        ...
        if len(new_devices) != len(self.current_devices):
            ...
            for dev in new_devices:
                ...
                btn = tk.Button(self.button_frame, text=f"{icon}{dev['name']}",
